...
def check_form(request, participant_id, form_id):
	form = B1Pregnancy.objects.get(id=int(form_id))	
	form.data_checked_id = request.user.username
	form.date_data_checked = datetime.now()
	form.save()
...
def edit_form(request, participant_id, form_id):
	...
	if section_number == "2":	
		...
		return process_sectionB1C(request, participant_id, form_id)
	elif section_number == "4":
		return process_sectionB1D(request, participant_id, form_id)
	elif section_number == "5":
		return process_sectionB1E(request, participant_id, form_id)
	elif section_number == "6":
		return process_sectionB1F(request, participant_id, form_id)
	else:
		return process_sectionB1A(request, participant_id, form_id)
...
def create_form(request, participant_id):
	if request.method == "POST":		
		...
		return render(request, 'forms_b/form.html', {'staff_list' : staff_list, 'context' : 'create_new_form', 'participant' : participant, 'date_admission' : date_admission})

@login_required(login_url='core:login')
def process_form(request, participant_id, form_id):
	print 0
	return redirect('/participant/'+str(participant_id)+'/form_b1/'+str(form_id)+'/sectionB1A')

@login_required(login_url='core:login')
def process_sectionB1A(request, participant_id, form_id):
	
	b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
	try:
		b1_obj = B1MedicalData.objects.get(b1_form=b1_form_obj)
		print "masuk ke update_section1"
		return update_sectionB1A(request, participant_id, form_id)	
	except:
		print "masuk ke create_section1"
		return create_sectionB1A(request, participant_id, form_id)

@login_required(login_url='core:login')
def create_sectionB1A(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
		b1_obj = B1MedicalData()
		...
		return show_sectionB1A(request, participant_id,form_id,False)

@login_required(login_url='core:login')
def update_sectionB1A(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_obj = B1MedicalData.objects.get(b1_form_id=int(form_id))
		b1_obj = save_sectionB1A(b1_obj, request, participant_id, form_id)
...
@login_required(login_url='core:login')
def show_sectionB1A(request, participant_id, form_id, is_save):
	form = B1Pregnancy.objects.get(id=int(form_id))
	participant = Participant.objects.get(id=int(participant_id))
	...
	if not request.user.is_staff:
		role = 'staff'
	try:
		b1_obj = B1MedicalData.objects.get(b1_form_id=form.id) 			
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b/sectionB1A.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b/sectionB1A.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked})
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true '
				return render(request, 'forms_b/sectionB1A.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj })
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b/sectionB1A.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj })	
	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b/sectionB1A.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})
...
@login_required(login_url='core:login')
def process_sectionB1B(request, participant_id,form_id):
	# if request.POST.get('form_id'):
	# 	int(form_id) = request.POST.get('form_id')
	b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
	print b1_form_obj
	try:
		b1_obj = B1UltrasoundScanResults.objects.get(b1_form=b1_form_obj)
		print b1_obj
		print "masuk ke update_section1"
		return update_sectionB1B(request, participant_id, form_id)	
	except:
		print "masuk ke create_section1"
		return create_sectionB1B(request, participant_id, form_id)

@login_required(login_url='core:login')
def create_sectionB1B(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
		b1_obj = B1UltrasoundScanResults()
		b1_obj.b1_form = b1_form_obj
		...
		print "masuk ke show section false"
		return show_sectionB1B(request, participant_id, form_id, False)

@login_required(login_url='core:login')
def update_sectionB1B(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_obj = B1UltrasoundScanResults.objects.get(b1_form_id=int(form_id))
		b1_obj = save_sectionB1B(b1_obj, request, participant_id, form_id)
		print "masuk ke show section yang diupdate true"
		return show_sectionB1B(request, participant_id, form_id, True)	
	else:
...
@login_required(login_url='core:login')
def show_sectionB1B(request, participant_id, form_id, is_save):
	form = B1Pregnancy.objects.get(id=int(form_id))
	participant = Participant.objects.get(id=int(participant_id))
	interviewer = User.objects.get(id=form.interviewer_id)
	is_save_all = form.is_save_all	
	...
	try:
		...
		b1_obj = B1UltrasoundScanResults.objects.get(b1_form_id=form.id)
		#date_exam = b1_obj.b2m_date_exam
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b/sectionB1B.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b/sectionB1B.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked})
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true '
				return render(request, 'forms_b/sectionB1B.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj })
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b/sectionB1B.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})	

	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b/sectionB1B.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})

def save_sectionB1B(b1_obj, request, participant_id, form_id):
	b1_form =  models.ForeignKey(B1Pregnancy, on_delete=models.PROTECT)
...
@login_required(login_url='core:login')
def process_sectionB1C(request, participant_id, form_id):
	# if request.POST.get('form_id'):
	# 	int(form_id) = request.POST.get('form_id')
	b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
	print b1_form_obj
	try:
		...
		print "masuk ke create_section1"
		return create_sectionB1C(request, participant_id, form_id)
...
def create_sectionB1C(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		...
		print "masuk ke show section false"
		return show_sectionB1C(request, participant_id, form_id, False)
...
@login_required(login_url='core:login')
def show_sectionB1C(request, participant_id, form_id, is_save):
	form = B1Pregnancy.objects.get(id=int(form_id))
	participant = Participant.objects.get(id=int(participant_id))
	interviewer = User.objects.get(id=form.interviewer_id)
	is_save_all = form.is_save_all	
	...
	try:
		...
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b/sectionB1C.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b/sectionB1C.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked })
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true '
				return render(request, 'forms_b/sectionB1C.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b/sectionB1C.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})	
	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b/sectionB1C.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})


def save_sectionB1C(b1_obj, request, participant_id, form_id):
	b1_form =  models.ForeignKey(B1Pregnancy, on_delete=models.PROTECT)
...
@login_required(login_url='core:login')
def process_sectionB1D(request, participant_id, form_id):
	
	b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
	try:
		b1_obj = B1CurrentSmookingHabits.objects.get(b1_form=b1_form_obj)
		print "masuk ke update_section1"
		return update_sectionB1D(request, participant_id, form_id)	
	except:
		print "masuk ke create_section1"
		return create_sectionB1D(request, participant_id, form_id)

@login_required(login_url='core:login')
def create_sectionB1D(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
		b1_obj = B1CurrentSmookingHabits()
		b1_obj.b1_form = b1_form_obj
		...
		print "masuk ke show section false"
		return show_sectionB1D(request, participant_id, form_id, False)

@login_required(login_url='core:login')
def update_sectionB1D(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_obj = B1CurrentSmookingHabits.objects.get(b1_form_id=int(form_id))
		b1_obj = save_sectionB1D(b1_obj, request, participant_id, form_id)
		print "masuk ke show section yang diupdate true"
		return show_sectionB1D(request, participant_id, form_id, True)	
	else:
...
@login_required(login_url='core:login')
def show_sectionB1D(request, participant_id, form_id, is_save):
	form = B1Pregnancy.objects.get(id=int(form_id))
	participant = Participant.objects.get(id=int(participant_id))
	interviewer = User.objects.get(id=form.interviewer_id)
	is_save_all = form.is_save_all	
	...
	if not request.user.is_staff:
		role = 'staff'
	try:
		b1_obj = B1CurrentSmookingHabits.objects.get(b1_form_id=form.id) 			
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b/sectionB1D.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b/sectionB1D.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked})
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true '
				return render(request, 'forms_b/sectionB1D.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b/sectionB1D.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})	
	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b/sectionB1D.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})
...
@login_required(login_url='core:login')
def process_sectionB1E(request, participant_id, form_id):	
	b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
	try:
		b1_obj = B1PollutanExposure.objects.get(b1_form=b1_form_obj)
		print "masuk ke update_section1"
		return update_sectionB1E(request, participant_id, form_id)	
	except:
		print "masuk ke create_section1"
		return create_sectionB1E(request, participant_id, form_id)

@login_required(login_url='core:login')
def create_sectionB1E(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
		b1_obj = B1PollutanExposure()
		b1_obj.b1_form = b1_form_obj
		...
		print "masuk ke show section false"
		return show_sectionB1E(request, participant_id, form_id, False)

@login_required(login_url='core:login')
def update_sectionB1E(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_obj = B1PollutanExposure.objects.get(b1_form_id=int(form_id))
		b1_obj = save_sectionB1E(b1_obj, request, participant_id, form_id)
		print "masuk ke show section yang diupdate true"
		return show_sectionB1E(request, participant_id, form_id, True)	
	else:
...
@login_required(login_url='core:login')
def show_sectionB1E(request, participant_id, form_id, is_save):
	form = B1Pregnancy.objects.get(id=int(form_id))
	participant = Participant.objects.get(id=int(participant_id))
	interviewer = User.objects.get(id=form.interviewer_id)
	is_save_all = form.is_save_all	
	...
	if not request.user.is_staff:
		role = 'staff'
	try:
		b1_obj = B1PollutanExposure.objects.get(b1_form_id=form.id) 			
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b/sectionB1E.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b/sectionB1E.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked})
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true '
				return render(request, 'forms_b/sectionB1E.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b/sectionB1E.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})	
	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b/sectionB1E.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})
...
@login_required(login_url='core:login')
def process_sectionB1F(request, participant_id, form_id):
	
	b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
	try:
		b1_obj = B1GestationalNutrition.objects.get(b1_form=b1_form_obj)
		print "masuk ke update_section1"
		return update_sectionB1F(request, participant_id, form_id)	
	except:
		print "masuk ke create_section1"
		return create_sectionB1F(request, participant_id, form_id)

@login_required(login_url='core:login')
def create_sectionB1F(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_form_obj = B1Pregnancy.objects.get(id=int(form_id))
		b1_obj = B1GestationalNutrition()
		b1_obj.b1_form = b1_form_obj
		...
		print "masuk ke show section false"
		return show_sectionB1F(request, participant_id, form_id, False)

@login_required(login_url='core:login')
def update_sectionB1F(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_obj = B1GestationalNutrition.objects.get(b1_form_id=int(form_id))
		b1_obj = save_sectionB1F(b1_obj, request, participant_id, form_id)
		print "masuk ke show section yang diupdate true"
		return show_sectionB1F(request, participant_id, form_id, True)	
	else:
...
@login_required(login_url='core:login')
def show_sectionB1F(request, participant_id, form_id, is_save):
	form = B1Pregnancy.objects.get(id=int(form_id))
	participant = Participant.objects.get(id=int(participant_id))
	interviewer = User.objects.get(id=form.interviewer_id)
	is_save_all = form.is_save_all	
	...
	if not request.user.is_staff:
		role = 'staff'
	try:
		b1_obj = B1GestationalNutrition.objects.get(b1_form_id=form.id) 			
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b/sectionB1F.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b/sectionB1F.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked})
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true'
				return render(request, 'forms_b/sectionB1F.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj })
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b/sectionB1F.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj })	
	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b/sectionB1F.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})
