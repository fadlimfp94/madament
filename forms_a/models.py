...
class A5PrePregnancySmoking(models.Model):
	...
	a5m_mother_smoking_status = models.CharField(choices=SMOKING_STATUS_LIST, max_length=1, default="", null=True)
	...
	##
	a5f_father_smoking_status = models.CharField(choices=SMOKING_STATUS_LIST, max_length=1, default="", null=True)
	...
	a5f_father_smoke_frequency = models.CharField(choices=SMOKING_FREQUENCY_LIST, max_length=1, default="", null=True)
