# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2017-01-15 17:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('a1m_residential_status', models.CharField(choices=[('1', 'Personal property'), ('2', 'Rent'), ('3', 'Family house')], max_length=1)),
                ...
                ('a1m_education_level', models.CharField(choices=[('1', 'Illiterate'), ('2', 'Elementary'), ('3', 'High School'), ('4', 'Undergraduate'), ('5', 'Postgraduate')], max_length=1)),
                ('a1m_family_income', models.IntegerField(null=True)),
                ('a1m_marital_status', models.CharField(choices=[('1', 'Married'), ('2', 'Divorced/Unmaried')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('a2m_working_status', models.CharField(choices=[('1', 'Employed'), ('2', 'Self-employed'), ('3', 'Unemployed')], max_length=1)),
                ...
                ('a2m_working_area', models.CharField(choices=[('1', 'Indoor'), ('2', 'Outdoor')], max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='A3Obstetric',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('a4f_education_level', models.CharField(choices=[('1', 'Illiterate'), ('2', 'Elementary'), ('3', 'High School'), ('4', 'Undergraduate'), ('5', 'Postgraduate')], max_length=1)),
                ('a4f_weight', models.IntegerField(null=True)),
                ('a4f_height', models.IntegerField(null=True)),
                ('a4f_employment_status', models.CharField(choices=[('1', 'Employed'), ('2', 'Unemployed'), ('3', 'Self-employed')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('a5m_mother_smoking_status', models.CharField(choices=[('1', 'Smoker'), ('2', 'Ex-smoker'), ('3', 'Never smoke')], max_length=1)),
                ...
                ('a5f_father_smoking_status', models.CharField(choices=[('1', 'Smoker'), ('2', 'Ex-smoker'), ('3', 'Never smoke')], max_length=1)),
                ...
                ('a5f_father_smoke_frequency', models.CharField(choices=[('1', 'Daily'), ('2', 'Weekly'), ('3', 'Monthly'), ('4', 'Never')], max_length=1)),
                ('a5f_smoke_in_front_of_mother', models.BooleanField()),
                ('a5c_colleagues_smoking_status', models.CharField(choices=[('1', 'Smoker'), ('2', 'Ex-smoker'), ('3', 'Never smoke')], max_length=1)),
