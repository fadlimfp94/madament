    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c3c_sex', models.CharField(choices=[('1', 'male'), ('2', 'female'), ('3', 'indetermined')], default='', max_length=1)),
                ...
                ('c3c_respiratory_diagnosis', models.CharField(default='', max_length=1)),
                ('c3c_other_respiratory_diagnosis', models.CharField(max_length=25)),
                ('c3c_respiratory_support', models.CharField(default='', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c1m_delivery_compilation', models.CharField(choices=[('0', 'No'), ('1', 'Yes')], default='', max_length=1)),
                ...
                ('c1m_hb', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('c1m_wbc', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('c1m_platelets', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('c1m_sgot', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('c1m_sgpt', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('c1m_ureum', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('c1m_creatinine', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
