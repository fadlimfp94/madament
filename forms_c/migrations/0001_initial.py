# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-03-05 07:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c1m_hb', models.DecimalField(decimal_places=3, max_digits=10)),
                ('c1m_wbc', models.DecimalField(decimal_places=3, max_digits=10)),
                ('c1m_platelets', models.DecimalField(decimal_places=3, max_digits=10)),
                ('c1m_sgot', models.DecimalField(decimal_places=3, max_digits=10)),
                ('c1m_sgpt', models.DecimalField(decimal_places=3, max_digits=10)),
                ('c1m_ureum', models.DecimalField(decimal_places=3, max_digits=10)),
                ('c1m_creatinine', models.DecimalField(decimal_places=3, max_digits=10)),
                ('c1m_vaginal_swab', models.BooleanField()),
                ('c1m_swab_date', models.DateField()),
                ('c_form', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='forms_c.CBaseLine')),
            ],
        ),
        migrations.CreateModel(
