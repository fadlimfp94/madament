...
urlpatterns = [
	...
	url(r'^(?P<form_id>[0-9]+)/sectionB1A$', views.process_sectionB1A, name='process_sectionB1A'),
	url(r'^(?P<form_id>[0-9]+)/sectionB1B$', views.process_sectionB1B, name='process_sectionB1B'),
	url(r'^(?P<form_id>[0-9]+)/sectionB1C$', views.process_sectionB1C, name='process_sectionB1C'),
	url(r'^(?P<form_id>[0-9]+)/sectionB1D$', views.process_sectionB1D, name='process_sectionB1D'),
	url(r'^(?P<form_id>[0-9]+)/sectionB1E$', views.process_sectionB1E, name='process_sectionB1E'),
	url(r'^(?P<form_id>[0-9]+)/sectionB1F$', views.process_sectionB1F, name='process_sectionB1F'),
]