...
def process_form(request, participant_id, form_id):
	print 0
	return redirect('/participant/'+str(participant_id)+'/form_b3/'+str(form_id)+'/sectionB1A')
...
def process_sectionB1A(request, participant_id, form_id):
	...
	try:
		b1_obj = B3MedicalData.objects.get(b1_form=b1_form_obj)
...
def update_sectionB1A(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_obj = B3MedicalData.objects.get(b1_form_id=int(form_id))
		b1_obj = save_sectionB1A(b1_obj, request, participant_id, form_id)
...
def show_sectionB1A(request,participant_id,form_id, is_save):
	...
	if not request.user.is_staff:
		role = 'staff'
	try:
		b1_obj = B3MedicalData.objects.get(b1_form_id=form.id) 			
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b3/sectionB1A.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b3/sectionB1A.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked})
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true '
				return render(request, 'forms_b3/sectionB1A.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj })
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b3/sectionB1A.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj })	
	except:
...
def process_sectionB1B(request, participant_id,form_id):
	...
	print b1_form_obj
	try:
		b1_obj = B3UltrasoundScanResults.objects.get(b1_form=b1_form_obj)
		print b1_obj
		print "masuk ke update_section1"
...
def update_sectionB1B(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_obj = B3UltrasoundScanResults.objects.get(b1_form_id=int(form_id))
		b1_obj = save_sectionB1B(b1_obj, request, participant_id, form_id)
		print "masuk ke show section yang diupdate true"
		return show_sectionB1B(request, participant_id, form_id, True)	
	else:
...
def show_sectionB1B(request, participant_id, form_id, is_save):
	...
	try:
		...
		b1_obj = B3UltrasoundScanResults.objects.get(b1_form_id=form.id)
		#date_exam = b1_obj.b2m_date_exam
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b3/sectionB1B.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b3/sectionB1B.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked})
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true '
				return render(request, 'forms_b3/sectionB1B.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj })
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b3/sectionB1B.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})	

	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b3/sectionB1B.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})
...
def show_sectionB1C(request, participant_id, form_id, is_save):
	...
	try:
		...
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b3/sectionB1C.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b3/sectionB1C.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked })
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true '
				return render(request, 'forms_b3/sectionB1C.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b3/sectionB1C.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})	
	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b3/sectionB1C.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})
...
def process_sectionB1D(request, participant_id, form_id):
	...
	b1_form_obj = B3Pregnancy.objects.get(id=int(form_id))
	try:
		b1_obj = B3CurrentSmookingHabits.objects.get(b1_form=b1_form_obj)
		print "masuk ke update_section1"
...
def update_sectionB1D(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_obj = B3CurrentSmookingHabits.objects.get(b1_form_id=int(form_id))
		b1_obj = save_sectionB1D(b1_obj, request, participant_id, form_id)
		print "masuk ke show section yang diupdate true"
		return show_sectionB1D(request, participant_id, form_id, True)	
	else:
...
def show_sectionB1D(request, participant_id, form_id, is_save):
	...
	if not request.user.is_staff:
		role = 'staff'
	try:
		b1_obj = B3CurrentSmookingHabits.objects.get(b1_form_id=form.id) 			
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b3/sectionB1D.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b3/sectionB1D.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked})
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true '
				return render(request, 'forms_b3/sectionB1D.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b3/sectionB1D.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})	
	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b3/sectionB1D.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})
...
def process_sectionB1E(request, participant_id, form_id):	
	b1_form_obj = B3Pregnancy.objects.get(id=int(form_id))
	try:
		b1_obj = B3PollutanExposure.objects.get(b1_form=b1_form_obj)
		print "masuk ke update_section1"
...
def update_sectionB1E(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_obj = B3PollutanExposure.objects.get(b1_form_id=int(form_id))
		b1_obj = save_sectionB1E(b1_obj, request, participant_id, form_id)
		print "masuk ke show section yang diupdate true"
		return show_sectionB1E(request, participant_id, form_id, True)	
	else:
...
def show_sectionB1E(request, participant_id, form_id, is_save):
	...
	if not request.user.is_staff:
		role = 'staff'
	try:
		b1_obj = B3PollutanExposure.objects.get(b1_form_id=form.id) 			
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b3/sectionB1E.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b3/sectionB1E.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked})
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true '
				return render(request, 'forms_b3/sectionB1E.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b3/sectionB1E.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj})	
	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b3/sectionB1E.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})
...
def process_sectionB1F(request, participant_id, form_id):
	...
	b1_form_obj = B3Pregnancy.objects.get(id=int(form_id))
	try:
		b1_obj = B3GestationalNutrition.objects.get(b1_form=b1_form_obj)
		print "masuk ke update_section1"
...
def update_sectionB1F(request, participant_id, form_id):
	if request.method == "POST" and request.POST.get('context') == "SAVE":
		b1_obj = B3GestationalNutrition.objects.get(b1_form_id=int(form_id))
		b1_obj = save_sectionB1F(b1_obj, request, participant_id, form_id)
		print "masuk ke show section yang diupdate true"
		return show_sectionB1F(request, participant_id, form_id, True)	
	else:
...
def show_sectionB1F(request, participant_id, form_id, is_save):
	...
	if not request.user.is_staff:
		role = 'staff'
	try:
		b1_obj = B3GestationalNutrition.objects.get(b1_form_id=form.id) 			
		if form.date_data_checked is not None:
			date_data_checked = form.date_data_checked
			if is_save:
				return render(request, 'forms_b3/sectionB1F.html', {'success' : True, 'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj,  'date_data_checked' : date_data_checked})
			else:
				print 'b'
				return render(request, 'forms_b3/sectionB1F.html', {'participant' : participant,'date_data_checked' : date_data_checked, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj, 'date_data_checked' : date_data_checked})
		else:
			print 'c'
			if is_save:	
				print 'masuk ke yang is_save = true'
				return render(request, 'forms_b3/sectionB1F.html', {'success' : True, 'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj })
			else:
				print 'masuk ke yang is_save = false'
				return render(request, 'forms_b3/sectionB1F.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'update', 'form' : form,'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission, 'b1' : b1_obj })	
	except:
		print "masuk ke except yang form B1"
		return render(request, 'forms_b3/sectionB1F.html', {'participant' : participant, 'is_save_all' : is_save_all ,'interviewer' : interviewer, 'role' : role, 'context' : 'create', 'form' : form, 'date_interviewed' : date_interviewed, 'date_data_entered' : date_data_entered, 'date_admission' : date_admission})
